...
use super::{BalanceType, PositionSide, RegCodeType, Symbol};
...
pub struct MarginDetail {
    ...
    #[serde(rename = "asOfTime", alias = "t", default)]
...
pub struct Position {
    ...
    /// Date position was opened (YYYYMMDD).
    #[serde(rename = "dateOpened", alias = "do", default)]
